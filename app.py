...
def predict( cat_3, cat_6, cat_8, cat_10, cat_11, cat_12, location_id, com_type,
...
# Create input interfaces for the model
cat_3 = gr.Number(lines=1, label="Enter cat_3 here")
cat_6 = gr.Number(lines=1, label="Enter cat_6 here")
cat_8 = gr.inputs.Textbox(lines=1, label="Enter cat_8 here")

cat_10 = gr.Number(lines=2, label="Enter cat_10 here")
cat_11 = gr.Number(lines=2, label="Enter cat_11 here")
cat_12 = gr.inputs.Textbox(lines=2, label="Enter cat_12 here")

location_id = gr.inputs.Textbox(lines=3, label="Enter location_id here")
com_type = gr.inputs.Textbox(lines=3, label="Enter com_type here")
value = gr.inputs.Textbox(lines=3, label="Enter value here")

num_date_review = gr.Number(lines=4, label="Enter num_date_review here")
unknown_var_7 = gr.Number(lines=4, label="Enter unknown_var_7 here")
unknown_var_8 = gr.Number(lines=4, label="Enter unknown_var_8 here")

unknown_var_9 = gr.Number(lines=5, label="Enter unknown_var_9 here")
unknown_var_13 = gr.Number(lines=5, label="Enter unknown_var_13 here")
unknown_var_17 = gr.Number(lines=5, label="Enter unknown_var_17 here")

social_friend_count = gr.Number(lines=6, label="Enter social_friend_count here")
dob = gr.Number(lines=6, label="Enter dob here")
time_1 = gr.inputs.Textbox(lines=6, label="Enter time_1 here")

time_2 = gr.inputs.Textbox(lines=7, label="Enter time_2 here")
date_2 = gr.inputs.Textbox(lines=7, label="Enter date_2 here")
date_3 = gr.inputs.Textbox(lines=7, label="Enter date_3 here")



# Create an output interface for the model's predictions
output = gr.inputs.Textbox(lines=7, label="Output")

# Wrap the model and interfaces in a Gradio interface
interface = gr.Interface(predict, [cat_3, cat_6, cat_8, cat_10, cat_11, cat_12, location_id, com_type,
        value, num_date_review, unknown_var_7, unknown_var_8, unknown_var_9,
        unknown_var_13, unknown_var_17, social_friend_count, dob, time_1,
        time_2, date_2, date_3], output, title="Local Model Predictor")
